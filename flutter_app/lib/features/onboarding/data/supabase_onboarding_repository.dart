...
class SupabaseOnboardingRepository implements OnboardingRepository {
  ...
  static const _fallbackIdentities = [
    SuggestedIdentity(
    ...
    SuggestedIdentity(
      ...
      description: 'Balance focus and reflection every day.',
      icon: 'brain',
      habits: [
        SuggestedHabit(title: 'Meditate for 5 minutes', category: 'meditation', frequencyType: 'daily'),
        SuggestedHabit(title: 'Plan tomorrow tonight', category: 'work', frequencyType: 'daily'),
      ],
    ),
  ];
